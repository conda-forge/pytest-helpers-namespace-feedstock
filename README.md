About pytest-helpers-namespace
==============================
...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytest-helpers-namespace-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11677&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytest-helpers-namespace-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `pytest-helpers-namespace` available on your platform with:
